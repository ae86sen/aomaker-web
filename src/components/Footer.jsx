      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            <Link to="/" className="flex items-center">
              <img
                ...
                alt="AOmaker Logo"
              />
              {/* <span className="ml-2 text-xl font-bold text-gray-900 dark:text-white">AOmaker</span> */}
            </Link>
          ...
          <div className="col-span-1">
            ...
            <ul className="mt-4 space-y-2">
              <li>
                <Link to="/features" className="text-base text-gray-600 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400">
                  特性
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/docs/quick-start" className="text-base text-gray-600 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400">
                  快速开始
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-12 border-t border-gray-200 dark:border-gray-700 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-500 dark:text-gray-400">
            &copy; {currentYear} AOmaker. 保留所有权利。
          </p>
          <div className="flex space-x-6 mt-4 md:mt-0">
            ...
            {/* <a
              href="https://twitter.com/aomaker_dev"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-500 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400"
            >
